...
/**
 * ContactCTA Block - Minimal Structure
 *
        ...
        <ScrollReveal>
          <div className="contact-content max-w-4xl mx-auto text-center p-8 md:p-12 lg:p-16">
            ...
            {(contactEmail || contactPhone) && (
              <div className="contact-info flex flex-col sm:flex-row gap-6 justify-center mb-8">
                {contactEmail && (
                  <a
            ...
            {socialLinks && socialLinks.length > 0 && (
              <div className="contact-social flex gap-4 justify-center mb-8">
